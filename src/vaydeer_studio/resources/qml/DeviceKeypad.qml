            ...
            Grid {
                ...
                Repeater {
                    ...
                    delegate: Button {
                        ...
                        y: isPressed ? Math.max(2, height * 0.07) : 0
                        scale: isPressed ? 0.91 : hovered ? 1.015 : 1.0
                        z: isPressed ? 0 : 1
                        ...
                        background: Rectangle {
                            ...
                            border.width: physicalKey.isSelected ? 2 : 1
                        ...
                        contentItem: Column {
                            anchors.fill: parent
                            anchors.margins: Math.max(4, parent.width * 0.09)
                            spacing: 1
                            Label {
                                width: parent.width
